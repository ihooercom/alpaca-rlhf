...
from alpaca_rlhf.deepspeed_chat.training.utils.ds_utils import get_eval_ds_config
...
from alpaca_rlhf.deepspeed_chat.training.utils.module.lora import convert_linear_layer_to_lora
from alpaca_rlhf.deepspeed_chat.training.utils.module.lora import only_optimize_lora_parameters
...
class DeepSpeedRLHFEngine:
    ...
    def _init_critic(self, critic_model_name_or_path):
        ...
        critic_engine, *_ = deepspeed.initialize(
            model=critic_model, optimizer=optim, lr_scheduler=lr_scheduler, config=ds_config
        )
