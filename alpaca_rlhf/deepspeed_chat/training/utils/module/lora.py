...
from deepspeed.compression.helper import recursive_setattr
...
def convert_lora_to_linear_layer(model):
    ...
    for name in repalce_name:
        ...
        with deepspeed.zero.GatheredParameters(
            _z3_params_to_fetch([module.weight, module.bias, module.lora_left_weight, module.lora_right_weight]),
            modifier_rank=0,
